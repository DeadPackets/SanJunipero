...
export const G11CheckpointSchema = z
  .object({
...
export function migrateCheckpointTable(db: Database.Database): void {
  db.exec(
    'CREATE TABLE IF NOT EXISTS g11_checkpoint (' +
