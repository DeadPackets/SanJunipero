 ...
 *  the scene caller's own 60 s bound, or the floor moves on while the line is still coming. */
export const FLOOR_TIMEOUT_MS = Number(process.env.SJ_FLOOR_TIMEOUT_MS) || 90_000
