...
/** A talk where the town finds out who somebody is matters more than a good morning. */
const TELLING_STAKES = 6
...
export class SceneCoordinator {
  ...
  #tellingIfStranger(scene: Scene): void {
    ...
    scene.stakes = Math.max(scene.stakes, TELLING_STAKES)
