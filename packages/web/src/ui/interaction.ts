...
// The arrows belong to whatever is under the pointer's focus first: a text field types with
// them and the map pans with them (StageMount, role="application"). Lens cycling is the
// fallback, never the interception.
