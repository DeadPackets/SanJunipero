...
export const BROADCAST_CAPTIONS: readonly BroadcastCaption[] = [
  ...
  { what: 'the day', from: 'sheet', selector: "[data-broadcast='on'] .almanac-day b" },
  { what: 'the dateline', from: 'sheet', selector: "[data-broadcast='on'] .almanac-date small" },
  {
    what: 'the town clock',
    from: 'sheet',
    selector: "[data-broadcast='on'] .almanac-clock strong",
  },
  { what: 'the weather', from: 'sheet', selector: "[data-broadcast='on'] .almanac-weather p" },
  { what: "the town's state", from: 'sheet', selector: "[data-broadcast='on'] .almanac-status" },
  ...
  { what: 'the quiet band', from: 'sheet', selector: "[data-broadcast='on'] .story-quiet p" },
