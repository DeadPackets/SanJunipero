...
export function gradingMatrix(weatherKind: string, season: Season): Float32Array | null {
  ...
  if (season === 'winter' && (weatherKind === 'snow' || weatherKind === 'clear')) return diagMatrix(WINTER_DIAG)
