...
// ★ Seven blocks creeping over a head told the truth and read as broken, and they crowded the
// one address the overhead slot was built to be. Progress belongs under the word it is about.
