...
export const GOOD_VERDICT = {
  hits: [
    ...
    },
    {
      ...
      sourceKind: 'speech',
      eventSeq: 130,
      quote: CHANGED_MIND_SPOKEN,
      quote2: CHANGED_MIND_THOUGHT,
      provenance2: 'mem_9',
      confidence: 0.91,
