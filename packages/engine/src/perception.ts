...
// body is near the walls: where your own things are is a thing you know, not a thing you see.
export type PerceivedStore = {
  ...
  ownerName?: string
  // Absent on the town's store: everybody's things are in it and it is nobody's roof.
  yours?: true
