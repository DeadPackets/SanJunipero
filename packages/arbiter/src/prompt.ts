...
"I cut down a tree by the river for its wood" is map: the town fells trees every day and already has the act.
"I hang the fish in the old shed over a slow smoke of green wood so it will keep past the week" is attempt: nobody has done it, yet the shed, the wood and the fire are all at hand, so the first step can be taken.
"I cast a new gear for the pump out of molten steel" is impossible: the town wholly lacks that craft, so there is no first step to take.
