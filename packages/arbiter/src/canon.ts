...
There is no factory within reach of this valley, no yard that pours metal, no counter that will sell them a finished part. Nothing arrives from outside. What cannot be made or mended between these two rivers cannot be had at all. So the new thing this town finds is far more often an arrangement between its people than a machine nobody here could build: a turn agreed at the well, a store held in common, a name that sticks to a place.`
