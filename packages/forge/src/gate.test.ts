...
describe('mechanicalGate', () => {
  it('★ passes an OFF-palette sprite — quantizing to MASTER_PALETTE is what destroyed the art', () => {
    const i = img(2, 2, [1, 2, 3, 255])
    i.data.set([0, 0, 0, 0], 0)
  ...
  it('fails on wrong size', () => {
    const r = mechanicalGate(img(2, 2, [1, 2, 3, 255]), { w: 4, h: 4, requireAlpha: false })
