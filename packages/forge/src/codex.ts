...
const COLS =
  'seq, id, class, desc, kind, meta, footprint_w, footprint_h, width_px, height_px, status, score, attempts, cost_usd, created_at'
  ...
  register(input: RegisterInput): AssetRecord {
    ...
    for (const cb of this.#listeners) {
      try {
        ...
        console.error('onAssetReady listener failed:', e)
      }
    }
    return rec
  }
