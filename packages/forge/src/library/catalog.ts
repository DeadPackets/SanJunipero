...
export const LibraryEntrySchema = z
  ...
  .strict()
  .refine((e) => (e.category === 'furniture') === (e.interior !== undefined), {
...
const furniture = (
  kind: string,
  desc: string,
  interior: LibraryEntry['interior'],
): LibraryEntry => ({
  kind,
  category: 'furniture',
  desc,
  ...
  interior,
  spritePx:
    interior === undefined || SHORT_OF_FOOTPRINT.has(kind)
      ? WORLD_SPRITE_PX
...
const TOOLS: LibraryEntry[] = [
  tool(
    'axe',
    'a woodcutter axe with a honey-wood haft and a warm-grey iron head, the blade edge kept bright and keen',
  ),
  tool(
    'hoe',
    'a long-handled garden hoe with a honey-wood shaft and a flat warm-grey blade turned at the neck',
  ),
  tool(
    'knife',
    'a kitchen knife lying flat, a long straight warm-grey blade with a keen straight edge and a pointed tip, set into a short honey-wood handle',
  ),
  tool('hammer', 'a carpenter hammer with a stubby honey-wood handle and a square warm-grey head'),
  tool(
    'shovel',
    'a digging shovel with a honey-wood shaft, a small crossbar grip and a rounded warm-grey scoop',
  ),
  ...
  tool(
    'fishing_rod',
    'a long thin rod of pale springy wood with a sage-green line wound thick ' +
  ...
  tool(
    'bucket',
    'a wooden pail of honey-wood staves bound by two warm-grey bands, with a rope handle across the top',
  ),
  tool(
    'waterskin',
    'a plump leather water flask the colour of tanned hide, stoppered with a carved wooden plug on a cord',
  ),
  tool(
    'needle',
    'a long sewing needle of polished warm-grey metal with a thread of dusty rose looped through its eye',
  ),
  tool(
    'saw',
...
const FOODS: LibraryEntry[] = [
  food(
    'bread',
    'a round cottage loaf with a crisp golden-brown crust and a cross scored across its top',
  ),
  food(
    'berries',
    'a small heap of round dusty-rose berries with two sage-green leaves tucked underneath',
  ),
  // "river" put a riverside cottage in the frame. Name the animal and nothing around it.
  food(
    'fish',
    'one whole raw fish, a single trout, lying flat on its side with its head to the left ' +
      'and its tail to the right, pale silver-blue scales, a soft sage-green back and one round eye',
  ),
  food(
    'venison',
    'a cut of deer meat, deep rose flesh with a rim of cream fat, tied with a loop of twine',
  ),
  food(
    'rabbit_meat',
    'a small dressed rabbit cut, pale rose flesh on a short bone, ready for the pot',
  ),
  food(
    'stew',
    'a shallow bowl of thick stew, honey-brown broth with chunks of root vegetable showing',
  ),
...
const MATERIALS: LibraryEntry[] = [
  ...
  material(
    'stone',
    'two rough quarried blocks of warm-grey stone stacked one on the other, flat faces chipped at the corners, darker grey in the shadows and no other colour',
  ),
  // Came back as timber planks twice; "slab" reads as a board unless the material is louder.
  material(
    'clay',
    "a lump of wet red-brown potter's clay, soft and earthen with no wood grain " +
  ...
  material(
    'fiber',
    'a neat hank of straw-coloured plant fibre folded once and tied at the middle with a thin cord, its two ends fanning out',
  ),
  material(
    'hide',
    'a folded animal skin, tan on the outside and cream on the underside, edges left ragged',
  ),
  material(
    'cloth',
    'a folded square of woven cloth in soft cream with a thin dusty-rose stripe along one edge',
  ),
  material(
    'rope',
    'a length of honey-brown rope wound into a flat round coil lying on its side, one frayed end tucked under',
  ),
  material(
    'charcoal',
...
const RITUAL: LibraryEntry[] = [
  ritual(
    'offering_bowl',
    'a shallow cream-stone bowl on a short foot, holding a few grains and a sprig of sage',
  ),
  ritual(
    'totem',
    'a tall narrow post of weathered honey-wood standing upright, one simple carved face near the top',
  ),
  ritual(
    'banner',
    'a narrow cloth pennant hanging from a crossbar, dusty rose with a cream circle stitched at its centre',
  ),
  ritual(
    'candle',
    'a stubby cream wax taper with a soft honey-gold flame and a bead of wax down one side',
  ),
  ritual(
    'garland',
    'a looping chain of small sage leaves and dusty-rose blossoms strung on a pale cord',
  ),
  ritual(
    'carved_charm',
    'a small carved token of pale bone on a leather thong, cut into a simple spiral',
  ),
]
...
const FURNITURE: LibraryEntry[] = [
  furniture(
    'bed',
    'a low wooden bed with a honey-wood frame, a cream mattress and a folded sage-green blanket at its foot',
  ...
  furniture('table', 'a sturdy honey-wood table with four square legs and a plain scrubbed top', {
    slots: { w: 1, h: 1 },
    placement: 'floor',
    interiorKinds: ['house', 'shed'],
  }),
  furniture(
    'chair',
    'a simple honey-wood chair with a slatted back and a worn cream cushion on the seat',
  ...
  furniture(
    'shelf',
    'a wall shelf of two honey-wood boards on warm-grey brackets, holding a jar and a folded cloth',
    { slots: { w: 1, h: 1 }, placement: 'wall', interiorKinds: ['house', 'storehouse', 'shed'] },
  ),
  furniture(
    'crate',
    'an open-topped wooden crate of pale slats, packed with straw and a rounded bundle',
    { slots: { w: 1, h: 1 }, placement: 'floor', interiorKinds: ['storehouse', 'shed'] },
  ),
  furniture(
    'barrel',
    'a squat barrel of honey-wood staves with two warm-grey hoops and a flat lid',
  ...
  furniture(
    'rug',
    'a rug and nothing else: a flat woven textile lying face-up on the ground, ' +
  ...
  furniture(
    'hearth',
    'a cream-stone fireplace set against a wall, with a low fire of honey-gold flames and a warm-grey chimney hood',
    {
      slots: { w: 1, h: 1 },
      placement: 'wall',
      interiorKinds: ['house'],
  ...
  furniture(
    'lantern',
    'a wall lamp of warm-grey metal and pale glass, hanging from a short bracket with a steady flame inside',
    {
      slots: { w: 1, h: 1 },
      placement: 'wall',
  ...
  furniture(
    'loom',
    'an upright weaving frame of honey-wood posts with cream warp threads strung down its face',
    { slots: { w: 1, h: 2 }, placement: 'floor', interiorKinds: ['house', 'shed'] },
  ),
  furniture(
    'anvil',
    'a heavy warm-grey anvil on a thick honey-wood block, its face worn smooth in the middle',
    { slots: { w: 1, h: 1 }, placement: 'floor', interiorKinds: ['shed'] },
  ),
  furniture(
    'chest',
    'a lidded storage box of honey-wood with a curved top and a warm-grey clasp at the front',
    { slots: { w: 1, h: 1 }, placement: 'floor', interiorKinds: ['house', 'storehouse'] },
  ),
  furniture(
    'stool',
    'a small three-legged stool of honey-wood with a round seat and splayed legs',
    { slots: { w: 1, h: 1 }, placement: 'floor', interiorKinds: ['house', 'shed'] },
  ),
  furniture(
    'cookpot',
    'a round cooking pot of warm-grey iron with two side handles and a wooden lid resting askew',
    { slots: { w: 1, h: 1 }, placement: 'floor', interiorKinds: ['house'] },
  ),
]

export const LIBRARY: readonly LibraryEntry[] = Object.freeze([
  ...TOOLS,
  ...FOODS,
  ...MATERIALS,
  ...RITUAL,
