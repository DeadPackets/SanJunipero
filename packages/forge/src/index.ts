// The light barrel: nothing reachable from here may pull the 9.7 MB of LLM SDK that lives behind
// the separate `@sj/forge/gen` entry point, which only the live path loads.
...
export { cellAnchor, processHiResCell, trimToFigure } from './hires.js'
