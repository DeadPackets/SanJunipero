...
if (FOUNDER === undefined || SLEEP_RAW === undefined)
  throw new Error('FOUNDER and SLEEP_RAW are required')
...
console.log(
  `  cell  ${r.cell.width}x${r.cell.height}  factor ${r.plan.factor}  source x${r.plan.sourceScale.toFixed(3)}`,
)
