...
export const ROAD_AUTOTILE_KEYS = [
  ...
  't-no-n', 't-no-e', 't-no-s', 't-no-w',
  'cross',
  'cap-n', 'cap-e', 'cap-s', 'cap-w',
] as const
...
const BY_MASK: readonly RoadAutotileKey[] = [
  'cap-s', 'cap-n', 'cap-e', 'corner-ne',
  'cap-s', 'straight-ns', 'corner-es', 't-no-w',
  'cap-w', 'corner-wn', 'straight-ew', 't-no-s',
  'corner-sw', 't-no-e', 't-no-n', 'cross',
]
