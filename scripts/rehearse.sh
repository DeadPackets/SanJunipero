...
# Usage: pnpm rehearse [minutes]      Then: node --env-file=.env --import tsx scripts/score.mjs
# SPEED=4 runs the clock four times faster (a sim-day is 60 real minutes at SPEED=1).
set -u
...
PID=$!
echo "pid $PID, running $MINUTES min at speed $SPEED"
